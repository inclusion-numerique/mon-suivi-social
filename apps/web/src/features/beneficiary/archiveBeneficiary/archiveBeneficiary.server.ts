...
import { ArchiveBeneficiaryFeatureClient } from '@mss/web/features/beneficiary/archiveBeneficiary/archiveBeneficiary.client'
...
const getServerState = async ({ beneficiaryId }: { beneficiaryId: string }) => {
...
const executeMutation = async ({
  ...
  serverState: ArchiveBeneficiaryFeatureServer.ServerState
  input: ArchiveBeneficiaryFeatureClient.Input
  ...
  documents.forEach((document) => {
    deleteUploadedFile(document).catch((error) => {
      ...
      Sentry.captureException(error, {
        tags: {
          sensitive: true,
          feature: ArchiveBeneficiaryFeatureClient.name,
        },
      })
    })
  })
...
export const ArchiveBeneficiaryFeatureServer = {
  getServerState,
  executeMutation,
} satisfies MutationServer<
  ArchiveBeneficiaryFeatureClient.Input,
  ArchiveBeneficiaryFeatureServer.ServerState,
  ArchiveBeneficiaryFeatureServer.MutationResult
>

export namespace ArchiveBeneficiaryFeatureServer {
...
export const ArchiveBeneficiaryFeature = {
  ...ArchiveBeneficiaryFeatureClient,
  ...ArchiveBeneficiaryFeatureServer,
}
