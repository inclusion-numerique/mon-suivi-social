...
import { createMutationServer } from '@mss/web/features/createFeature'
import { EditStructureClient } from '@mss/web/features/structure/editStructure/editStructure.client.new'

export const EditStructureServer = createMutationServer({
  client: EditStructureClient,
  getServerState: async ({ input: { structureId } }) => {
