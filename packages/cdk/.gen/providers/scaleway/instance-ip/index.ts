...
export class InstanceIpTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: InstanceIpTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class InstanceIp extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new InstanceIpTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: InstanceIpTimeouts) {
