// https://www.terraform.io/docs/providers/scaleway/d/container_namespace
...
export interface DataScalewayContainerNamespaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/scaleway/d/container_namespace#id DataScalewayContainerNamespace#id}
  *
  ...
  * 
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/scaleway/d/container_namespace#name DataScalewayContainerNamespace#name}
  */
  readonly name?: string;
  /**
  * The ID of the Container namespace
  * 
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/scaleway/d/container_namespace#namespace_id DataScalewayContainerNamespace#namespace_id}
  */
  readonly namespaceId?: string;
  /**
  * The region you want to attach the resource to
  * 
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/scaleway/d/container_namespace#region DataScalewayContainerNamespace#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://www.terraform.io/docs/providers/scaleway/d/container_namespace scaleway_container_namespace}
*/
export class DataScalewayContainerNamespace extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/scaleway/d/container_namespace scaleway_container_namespace} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataScalewayContainerNamespaceConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataScalewayContainerNamespaceConfig = {}) {
    super(scope, id, {
  ...
  // destroy_registry - computed: true, optional: false, required: false
